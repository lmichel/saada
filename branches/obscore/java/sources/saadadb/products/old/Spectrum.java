...
public class Spectrum extends Product {
	 ...
	 */
	public Spectrum(File file, ConfigurationDefaultHandler mapping) throws SaadaException{		
		super(file, mapping);
	...
	protected void mapCollectionSpectralCoordinate() throws Exception {
		ConfigurationSpectrum cs = null;//(ConfigurationSpectrum)(this.mapping);
	...
	public boolean findSpectralCoordinateInPixels() throws Exception {
		...
		if( ext != null ) {
			 ...
			 */
			String unit =null; // ((ConfigurationSpectrum)(this.mapping)).getSpectralCordinateUnit();
			if( !"AutoDetect".equals(unit) ) {
			//	spectralCoordinate.setOrgUnit(((ConfigurationSpectrum)(this.mapping)).getSpectralCordinateUnit());
			}
			return true;
		}
		else {
...
//		return  spectralCoordinate.convertWCS(this.tableAttributeHandler, ((MappingSpectrum)(this.mapping.getMapping())).getAbcisseUnit());
	return false;}
