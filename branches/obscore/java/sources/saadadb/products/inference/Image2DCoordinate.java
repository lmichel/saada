...
public class Image2DCoordinate{
	...
	public void setImage2DCoordinate(Map<String, AttributeHandler> tableAttributeHandler) throws Exception{
		double det ;
	...
	protected void Dss(Map<String, AttributeHandler> tableAttributeHandler) throws Exception {
		int sign = 1;
		double det ;
		proj = 2 ;
