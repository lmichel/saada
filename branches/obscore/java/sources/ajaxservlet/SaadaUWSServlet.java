 ...
 * <p>This file is a fork of the original library uws4.0 which prevented inheritance</p>
 * <p> It now inherits of SaadaServlet</p>
 * <p>
 ...
 * @version 01/2015
 */
public abstract class SaadaUWSServlet extends SaadaServlet implements UWS, UWSFactory {
	...
	protected void doAddJob(UWSUrl requestUrl, HttpServletRequest req, HttpServletResponse resp, JobOwner user) throws UWSException, ServletException, IOException {
		...
		if (jobsList.addNewJob(newJob) != null){
			...
			//jobsList.getExecutionManager().execute(newJob);
		}else
