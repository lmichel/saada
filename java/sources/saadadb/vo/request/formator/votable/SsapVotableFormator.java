...
//			}
	 ...
	 * @throws Exception
	 */
/*	protected String lookForAMatch(SpectrumSaada obj, SavotField sf)
			throws Exception {
		String retour = "";
		AttributeHandler hdlr = Database.getCachemeta().getAtt_extend_spectra(
				sf.getName());
		if (hdlr != null) {
			Object value = obj.getFieldValue(hdlr.getNameattr());
			if (value != null) {
				// System.out.println(value.toString());
				// System.out.println("sf unit " + sf.getUnit());
				// System.out.println("hdlr unit " + hdlr.getUnit());
