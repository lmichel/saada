...
//			LinkedHashMap<String, AttributeHandler> new_ah = this.current_prd.productAttributeHandler;
...
//						, new ArrayList<AttributeHandler>(this.current_prd.productAttributeHandler.values()))).updateUCDTable(mc.getId());
//				GenerationClassProduct.buildJavaClass(this.current_prd.productAttributeHandler
