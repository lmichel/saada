 ...
 * @version $Id$
 */
public class EnergyShaker extends ParamShaker{
	...
	EnergyShaker() throws Exception{
		super();
		this.paramsOfInterest = new HashSet<String>();
		this.paramsOfInterest.add("em_min");
		this.paramsOfInterest.add("em_max");
	}
	...
	public static void main(String[] args) throws Exception {
		...
		EnergyShaker sp = new EnergyShaker();
