...
public class SaadaClassReloader extends ClassLoader {
	...
	final private static  String PACKAGE = "generated." + Database.getDbname() + ".";
	final private static  String CLASSPATH =  Database.getRoot_dir() 
	+ Database.getSepar() + "class_mapping"
	+ Database.getSepar() + "generated"
	+ Database.getSepar() + Database.getDbname()
	+ Database.getSepar();
	...
	public  Class loadClass(String classname) throws ClassNotFoundException {
		...
		try {
			...
			Class retour = defineClass( PACKAGE + classname,
