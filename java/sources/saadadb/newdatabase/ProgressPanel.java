...
public class ProgressPanel extends JPanel {
	...
	JLabel[] labels = {new JLabel("1- Check SaadaDB Directory")
	                 , new JLabel("2- Check Database Connectivity")
                     , new JLabel("3- Check Database reader role")
                     , new JLabel("4- Check Tomcat Installation")
                     , new JLabel("5- Add Collection User Attributes")
                     , new JLabel("6- Set Coordinate Systems and Units")
                     , new JLabel("7- Create SaadaDB")
	                               };
