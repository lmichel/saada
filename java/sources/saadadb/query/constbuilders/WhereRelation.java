...
public final class WhereRelation{
	...
	public final MatchPattern[] getPattern(){return this.patterns;}
	...
	private final void parse(String strQ) throws SaadaException{
		...
		if(m.find()){
			...
			else{QueryException.throwNewException(SaadaException.SYNTAX_ERROR,"In WhereRelation... Humm... I don't understand! This is a regex error not supposed to happen!");}
		}
		else{
