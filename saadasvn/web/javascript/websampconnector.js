...
var WebSampConnector = {
   ...
   Netscape: window.navigator.appName.indexOf("Netscape") != -1,
    ...
    */
   /*\
    * Modified by LM to avoid a 'Failed to load resource 
    * http://... /org.voparis.WebSampConnector on Chrome
    */
   connect: function() {
      ...
      if (this.IE) {
         var parameters = " codebase='" + this.jAppletCodeBase + "'"
            ...
            + " mayscript='true'>";
         applet = "<object type='application/x-java-applet;version=" + this.javaVersion + "'"
         + " id='" + this.jAppletId + "' name='" + this.jAppletId + "'"
         + " archive='WebSampConnector-" + this.jAppletVersion + ".jar'"
         + " style='visibility: hidden; position: absolute; top:0; left:0;' width='10' height='10'"
         + parameters
         ...
         + " </object>";
    	  ...
    	  applet = "<APPLET\n" 
    		  + " id='" + this.jAppletId + "'\n"
    		  + "codebase='applets/'\n"
    		  + "archive=WebSampConnector-1.5.jar \n"
    		  + "code=org.voparis.WebSampConnector width=10 height=10  MAYSCRIPT> \n"
    		  + "<PARAM NAME='cgi' VALUE='/java'> \n"
    		  + "<span id='wsc-no-java' style='position: absolute; top: 10%; width: 50%; margin: 0 25%; background: white; border: 1px solid black; padding: 1em; text-align: center;'> \n" 
    		  + "WebSampConnector requires Java plugin version 1.6 or later to run.<br />  \n"
    		  + "<a href='http://java.sun.com/products/plugin/downloads/'>Get the latest Java plugin here</a>  \n"
    		  + "or <button onclick='this.parentNode.parentNode.removeChild(this.parentNode)'>hide this message</button>\n"
    		  + "</span>\n"
    		  + "</APPLET>\n";
