...
import saadadb.vo.request.formator.VOResultFormator;
...
public abstract class VOTableFormator extends VOResultFormator  {
	...
	public void buildDataResponse( ) throws Exception {
		...
		String qp = "Query parameters:\n";
		for(Entry<String, String> s: this.protocolParams.entrySet() ) {
			qp += "   " + s.getKey() + ": " + s.getValue() + "\n";
		}
		writer.writeDescription(qp);
	 ...
	 */
	protected void writeDMFieldsAndGroups() {
