...
public abstract class FITSFormator extends VOResultFormator  {
	...
	private Object getValueVector(UTypeHandler typeHandler) throws Exception {
		...
		if( this.resultSize == 0 ) {
			...
			Object retour;
			if( type.equals("int") ) {
				retour = new int[this.resultSize];
			}
			else if( type.equals("short") ) {
				retour = new short[this.resultSize];
			}
			else if( type.equals("long") ) {
				retour = new long[this.resultSize];
			}
			else if( type.equals("float") ) {
				retour = new float[this.resultSize];
			}
			else if( type.equals("double") ) {
				retour = new double[this.resultSize];	
			}
			else if( type.equals("boolean") ) {
				retour = new boolean[this.resultSize];
			}
			else if( type.equals("char")&& size == 1 ) {
				retour = new char[this.resultSize];
			}
			else if( type.equals("byte")&& size == 1 ) {
				retour = new byte[this.resultSize];
			}
			else  {
				retour = new String[this.resultSize];
			}
			return retour;
		}	
	}
