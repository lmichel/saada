...
CREATE OR REPLACE  FUNCTION boxcovers(ra_roi DOUBLE , dec_roi DOUBLE , roi_size DOUBLE ,ra_box DOUBLE , dec_box DOUBLE , box_size_ra DOUBLE , box_size_dec DOUBLE ) RETURNS BOOLEAN DETERMINISTIC
BEGIN
DECLARE combinated_box_size DOUBLE  DEFAULT 0;
	...
	ELSE 
		RETURN isinbox(ra_box, dec_box, (box_size_ra + roi_size), (box_size_dec + size_roi), ra_roi, dec_roi);
	END IF;
