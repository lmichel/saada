...
*
 */
public class QueryPosListTester extends GridBuilder{
	 ...
	 */
	QueryPosListTester(String pos, int size) throws Exception {
		super(pos, size, "PosListTester");
	}
	...
	private void testQuery() throws Exception {
		...
		int cpt = 0;
		while( srs.next()) {
			System.out.print(Database.getCache().getObject(srs.getOid()).getNameSaada() + " ");
			if( (cpt%4) == 0 ) {
				System.out.println("");
			}
			cpt++;
