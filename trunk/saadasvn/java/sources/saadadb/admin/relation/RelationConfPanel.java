...
public class RelationConfPanel extends JPanel {
	...
	public RelationConfPanel(JFrame frame, Dimension dim) {
		...
		/*
		 * Create a new relation configuration
		 */
		...
		/*
		 * Load a relation stored in the config file
		 */
		...
		/*
		 * Create the new relation or save the correlator query
		 */
		...
		create_button.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent e){ 
				try {
					...
					/*
					 * A relation already existing must never been created
					 */
