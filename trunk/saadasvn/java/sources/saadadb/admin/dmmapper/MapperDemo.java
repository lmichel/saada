...
import saadadb.admin.MetaDataPanel;
...
public class MapperDemo  extends JFrame {
	/**
	 * 
	 */
	 ...
	 */
	public MapperDemo(boolean nolog, Point p) throws SaadaException {
		super("Saada " + Database.version() + ": " + Database.getDbname() + " Data Model Mapper Prototype");
		...
		this.addWindowListener(new WindowAdapter(){
			...
			public void windowClosing(WindowEvent we){	        	
				if( SaadaDBAdmin.showConfirmDialog(MapperDemo.this, "Do you really want to exit?") ==  true ) {
					System.exit(1);
				}
	        }
	      });
		...
		webapp_btn.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent e){ 
				CmdThread ct = new CmdDeployWebApp(MapperDemo.this);
				ct.start();		
			}
		});
		JButton debug_btn;
		if( Messenger.debug_mode )
			...
			debug_btn = new JButton("Set Debug ON");						    /* + " where  name_coll = '" + tree_path_components[1] + "' order by pk";*/
		...
		exit_btn.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent e){ 
				if( SaadaDBAdmin.showConfirmDialog(MapperDemo.this, "Do you really want to exit ?") ) {
					System.exit(0);
				}
			}
		});
	 ...
	 */
	public void showProduct(Object[] tree_path_components) throws Exception {
	...
	public static void main(String[] args){
		try {		
			...
			SwingUtilities.invokeLater(new Runnable() {
				...
				public void run() {
					try {
						new MapperDemo(ap.isNolog(), null);
					} catch (SaadaException e) {
						Messenger.printStackTrace(e);
						System.exit(1);
					}
