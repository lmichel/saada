...
public class SimbadTooltip extends SaadaServlet {
			...
			if( position == null || position.length() == 0 ){
				...
				while ((boeuf = in.readLine()) != null) {
					if( data_found ) {
						...
						if( pos >= 3 ) {
							String type = fields[pos]; pos--;
							String dec = fields[pos]; pos--;
	...
	public static void main(String[] args) throws Exception {
		...
		//http://simbad.u-strasbg.fr/simbad/sim-script?submit=submit+script%20%20%20%20%20%20%20%20%20*%20&script=format+object+form1+%22%25IDLIST%281%29|%25COO%28A%29|%25COO%28D%29|%25COO%28E%29|%25COO%28Q%29|%25COO%28B%29|%25COO%28W%29|%25COO%28P%29%22%0D%0AM104%0D%0A
		String url = "http://simbad.u-strasbg.fr/simbad/sim-script?submit=submit+script&script=";
