CREATE OR REPLACE FUNCTION corner00_ra(ra DOUBLE PRECISION,de DOUBLE PRECISION,size_ra DOUBLE PRECISION,size_de DOUBLE PRECISION) RETURNS DOUBLE PRECISION IMMUTABLE AS $$
DECLARE 
